...
//let link2 = "https://www.lazada.co.th/products/2022-i5661814104-s24147192009.html?trafficFrom=17449020_303586&laz_trackid=2:mm_321251106_287552583_2244402583:clkgikqsm1ir5bco0e9r4o&mkttid=clkgikqsm1ir5bco0e9r4o";  // ลิงก์ Lazada
 ...
 files = [
  ...
  { name: 'Kamii script (animation).mcpack', url: 'addon/Kamii script (animation).mcpack' },
  { name: 'Roll Behavior (animation).mcpack', url: 'addon/Roll Behavior (animation).mcpack' },
  { name: 'Roll Resource (animation).mcpack', url: 'addon/Roll Resource (animation).mcpack' },
  { name: 'UI Queue (animation).mcpack', url: 'addon/UI Queue (animation).mcpack' },
